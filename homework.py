...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_callorie_2) * self.weight / self.M_IN_KM * duration_minutes
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        (self.get_mean_speed() ** coeff_callorie_4 // self.height)* 
        coeff_callorie_5 * self.weight) * duration_minutes
        return spent_calories
